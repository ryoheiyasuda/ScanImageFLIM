...
global state spc gui gh
    ...
    try
        ...
        fig_pos.project= get(gui.spc.figure.project, 'position');
        fig_pos.lifetimeMap = get(gui.spc.figure.lifetimeMap, 'position');
        fig_pos.lifetime = get(gui.spc.figure.lifetime, 'position');
        fig_pos.scanImg = get(gui.spc.figure.scanImgF, 'position');
