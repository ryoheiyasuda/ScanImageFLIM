...
% Last Modified by GUIDE v2.5 13-Sep-2016 09:25:41
...
try
    ...
    if exist(fname, 'file')
        load(fname);
%         set(gh.spc.pq_parameters.figure1, 'position', fig_pos.pq_parameters);
        ...
        set(gui.spc.figure.lifetimeMap, 'position', fig_pos.lifetimeMap);
        set(gui.spc.figure.lifetime, 'position', fig_pos.lifetime);
        set(gui.spc.figure.scanImgF, 'position', fig_pos.scanImg);
    end
