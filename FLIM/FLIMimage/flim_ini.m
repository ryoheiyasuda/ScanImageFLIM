...
%%%    
    ...
    if strcmp(state.spc.init.dllname, 'TH260lib')
        ...
        state.spc.acq.SPCdata.binning=0;
        
        state.spc.acq.SPCdata.HW_Model = 'TimeHarp 260 N';
        state.spc.acq.SPCdata.sync_offset=-1000;
        state.spc.acq.SPCdata.sync_trigger_level=-50; %PQ
        state.spc.acq.SPCdata.sync_zc_level=0;
        state.spc.acq.SPCdata.sync_freq_div=4;
        state.spc.acq.SPCdata.sync_offset=7000; %ps

        state.spc.acq.SPCdata.input_trigger_level(1)=-50; %PQ
        state.spc.acq.SPCdata.input_trigger_level(2)=-50; %PQ
        state.spc.acq.SPCdata.input_zc_level(1)=0;
        state.spc.acq.SPCdata.input_zc_level(2)=0;        
        state.spc.acq.SPCdata.input_offset(1)=0; %s
        state.spc.acq.SPCdata.input_offset(2)=0; %s
        state.spc.acq.SPCdata.n_channels=2;
        state.spc.acq.SPCdata.mode=3;
        state.spc.acq.SPCdata.resolution=250;
